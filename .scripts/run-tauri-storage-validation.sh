...
run_step "cargo-test-license-control-suite-storage-deactivation" cargo test --manifest-path vendor/license-control-suite/Cargo.toml --test user_reg_core_service_int
